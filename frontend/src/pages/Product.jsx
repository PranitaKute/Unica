    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <button onClick={() => addToCart(productData._id)} className='bg-black text-white px-8 py-3 text-sm active:bg-gray-700 mt-4'>
            ADD TO CART
            </button>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>
            ...
            convenience, accessibility, and global reach they offer.
          </p>
          <p>
            ...
            variations. Each product usally has its own dedicated page with relevant information. 
          </p>
        </div>
      </div>
